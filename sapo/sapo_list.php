<?php
    include_once ('../sapo/sapo_cab2.php');
?>
...
<!--SLIDESHOW DA PAGINA INICIAL-->
  ...
  <link rel="stylesheet" href="../livraria/style.css" />
	...
	<body>
		...
		<article role="main" class="ui-content" id= "list">
	...
	// ki o cabaxalho enviado pelo arkivo HTML seja mesmo que HTTP do servidor
          ...
          do{
			...
			echo "<li><a class=\"cont2\" style=\"white-space: normal; text-align: justify\"  href="."/sapo/sapo_cont.php?name=".current($link2),">",current($cabecalho2),"</a>","<li>";
				
				//echo current($cabecalho2), ".", current($link2), "<br/>";
          	
          } while( next($cabecalho2)&& next($link2));
