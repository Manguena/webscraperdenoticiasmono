<?php
    include_once ('../portgov/portgov.php');
?>
...
class="cont"
	...
	// ki o cabaxalho enviado pelo arkivo HTML seja mesmo que HTTP do servidor
		...
		$link=links_portgov();
		$cabecalho=cabeca_portgov();
		
		do{
			
			echo "<li><a class=\"cont2\" style=\"white-space: normal; text-align: justify\"  href=\"/portgov/portgov_cont.php?name=", current($link),"\"  data-prefetch=\"true\">",current($cabecalho),"</a>", "<li>";
			
		} while(next($link)&& next($cabecalho));
