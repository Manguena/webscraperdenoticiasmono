...
<link rel="stylesheet" href="../livraria/style.css"/>
	...
	// ki o cabaxalho enviado pelo arkivo HTML seja mesmo que HTTP do servidor
			...
			print "<br/ >";
			$cabecalho=noticias_cabe();
			$link=noticias_links();
          do{
          	
			// imprimir os links para acesso as noticias
			echo "<li><a class=\"cont2\" style=\"white-space: normal; text-align: justify\"  href="."/noticias/noticias_cont.php?name=",current($link)," data-prefetch=\"true\">",current($cabecalho),"</a>","<li>";
				
				//echo current($cabecalho2), ".", current($link2), "<br/>";
          	
          } while( next($cabecalho)&& next($link));
